              ...
              {item.dropdown && openMenu === item.name && (
                <div className={styles.megaMenu}>
                  <div className={styles.megaMenuContent}>
                    ...
                    {/* --- THIS CONTENT IS NOW RELEVANT --- */}
                    <div className={styles.promoSection}>
                      <h3>Get Every Component We Make</h3>
                      <p>Empower your entire team with our Enterprise Universal bundle, including source code and premium support.</p>
                      <Link href="/bundles#enterprise" className="btn btnSecondary">Explore Universal</Link>
                    </div>
                  </div>
                </div>
              )}
